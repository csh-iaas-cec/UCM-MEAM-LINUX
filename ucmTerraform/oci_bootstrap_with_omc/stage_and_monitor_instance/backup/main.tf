...
output "Availability_Domain" {
  value = ["${oci_core_instance.omc_managed_instance.availability_domain}"]
}

//output "subnetCIDR" {
  //value = ["${oci_core_instance.omc_managed_instance.subnet_id}"]
//}

output "Public_IP_of_instance" {
  value = ["${oci_core_instance.omc_managed_instance.public_ip}"]
}

output "Private_IP_of_instance" {
  value = ["${oci_core_instance.omc_managed_instance.private_ip}"]
}

output "Image" {
  value = ["${oci_core_instance.omc_managed_instance.image}"]
}

output "Shape" {
  value = ["${oci_core_instance.omc_managed_instance.shape}"]
}
